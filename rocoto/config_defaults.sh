...
#-----------------------------------------------------------------------
#
BASEDIR="/path/to/directory/of/regional_workflow/and/NEMSfv3gfs/clones" # HOMEfv3; ultimately HOMErrfs
TMPDIR="/path/to/temporary/work/directories" # 
UPPDIR="/path/to/UPP/executable"
EXPT_BASEDIR="" # COMROOT; contains UPP output, BUFR soundings, obs, LBCs, model configure file, 
                #          parameter config settings for a given cycle (e.g. chgres settings)
EXPT_SUBDIR=""
# GESROOT; contains restart files, ICs, "hold" (contains most recent best state?), 
#          DA satelline files
...
#-----------------------------------------------------------------------
#
CDATE_FIRST_CYCL="YYYYMMDDHH"
CDATE_LAST_CYCL="YYYYMMDDHH"
#CYCL_HRS=( "HH1" "HH2" )
CYCL_INTVL="HH"
fcst_len_hrs="24"
#
...
NET=fv3cam
RUN=fv3sar
model=fv3sar     # fv3sar (cold start) or fv3sar_da (with DA)
mainroot=/gpfs/dell1
tmpdir=stmp
comdir=ptmp
rzdmuser=bblake
...
NHOUR=/gpfs/dell1/nco/ops/nwprod/prod_util.v1.1.0/exec/ips/nhour

CRES=768          #-- FV3 equivalent to 13-km global resolution
CASE=C${CRES}
gtype=regional    # grid type = uniform, stretch, nest, or regional

HOMEfv3=/gpfs/dell2/emc/modeling/noscrub/$USER/regional_workflow
PARMfv3=$HOMEfv3/parm
...
COMROOT=${mainroot}/${comdir}/${USER}/com
GESROOT=${mainroot}/${comdir}/${USER}/nwges
GESROOT_HOLD=${mainroot}/${comdir}/${USER}/nwges/${RUN}.hold
