...
DATE_FIRST_CYCL="20201227"
DATE_LAST_CYCL="20201227"
CYCL_HRS=( "00" )
...
#
EXTRN_MDL_SOURCE_BASEDIR_ICS="/scratch1/NCEPDEV/rstprod/com/gfs/prod/gfs.20201227/00"
EXTRN_MDL_FILES_ICS=( "gfs.pgrb2.0p25.f000" )
EXTRN_MDL_SOURCE_BASEDIR_LBCS="/scratch1/NCEPDEV/rstprod/com/gfs/prod/gfs.20201227/00"
