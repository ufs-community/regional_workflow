...
# files with locations and names as specified by EXTRN_MDL_USER_BASEDIR_ICS/
# LBCS and EXTRN_MDL_USER_FILES_ICS/LBCS.
#
...
#
#EXTRN_MDL_USER_BASEDIR_ICS="/scratch2/BMC/det/UFS_SRW_app/v1p0/model_data/FV3GFS"
#EXTRN_MDL_USER_FILES_ICS=( "gfs.pgrb2.0p25.f000" )
#EXTRN_MDL_USER_BASEDIR_LBCS="/path/to/model_data/FV3GFS"
#EXTRN_MDL_USER_FILES_LBCS=( "gfs.pgrb2.0p25.f006" "gfs.pgrb2.0p25.f012" "gfs.pgrb2.0p25.f018" "gfs.pgrb2.0p25.f024" \
