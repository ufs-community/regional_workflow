...
# (extrn_mdl_name), sets and returns the default value of the 
# base directory (default_basedir) containing the files generated by 
...
# a null string for the base directory.  
#
#-----------------------------------------------------------------------
#
...
#-----------------------------------------------------------------------
#
# Set the default value of the base directory (default_basedir) 
...
#-----------------------------------------------------------------------
#
# If default_basedir was not set above to a non-empty string, the 
# returned value (in the variable outvarname_extrn_mdl_default_basedir) 
