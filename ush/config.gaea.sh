...
EXTRN_MDL_SOURCE_BASEDIR_ICS="/lustre/f2/dev/Dom.Heinzeller/ufs-srweather-app/data"
EXTRN_MDL_FILES_ICS=( "gfs.pgrb2.0p25.f000" )
EXTRN_MDL_SOURCE_BASEDIR_LBCS="/lustre/f2/dev/Dom.Heinzeller/ufs-srweather-app/data"
