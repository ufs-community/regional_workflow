...
HPSS_TAR_FILE=/NCEPDEV/emc-naqfc/5year/Barry.Baker/emissions/BOUNDARY_CONDITIONS/NAQFC_RRFS_CMAQ_C401.tar
...
Fetching chemical lateral boundary condition filesfrom HPSS:
  HPSS_TAR_FILE = ${HPSS_TAR_FILE}
  CHEM_BOUNDARY_CONDITION_FILE = ${CHEM_BOUNDARY_CONDITION_FILE}
  "
    htar -xvf ${HPSS_TAR_FILE} ${CHEM_BOUNDARY_CONDITION_FILE}
fi
#
#-----------------------------------------------------------------------
#
