...
#                      .                                             .
# Script name:         exfv3sar_gsianl_firstguess.sh
# Script description:  Run FV3SAR GSI analysis at t-6 h to start the hourly DA cycle
...
cp filelist03 $COMOUT/${RUN}.t${CYCrun}z.filelist03.tm06
