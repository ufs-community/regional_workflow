...
PREDEF_GRID_NAME="RRFS_HRRR25km"
...
GRID_DIR="/scratch2/BMC/det/FV3LAM_pregen/grid/RRFS_HRRR25km"

RUN_TASK_MAKE_OROG="FALSE"
OROG_DIR="/scratch2/BMC/det/FV3LAM_pregen/orog/RRFS_HRRR25km"

RUN_TASK_MAKE_SFC_CLIMO="FALSE"
SFC_CLIMO_DIR="/scratch2/BMC/det/FV3LAM_pregen/sfc_climo/RRFS_HRRR25km"
