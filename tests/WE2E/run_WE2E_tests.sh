...
build_env_fn:
Specify the build environment (see ufs-srweather-app/envs) to use for 
the workflow. (e.g. build_cheyenne_gnu.env). If a \"gnu\" compiler is 
specified, it must also be specified with the \"compiler\" option.
